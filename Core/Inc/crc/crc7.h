 ...
 * Each CRC calculation must start using the CRC7_ZERO value
 * 
...
/// Initialize the CRC calculation component by calculating the CRC table for each byte
void Crc7Initialize();
...
/// Calculates the CRC of a stream of data
